...
import org.smartregister.tasking.TestRevealApplication;
...
import static org.smartregister.tasking.util.Constants.CONFIGURATION.ADMIN_PASSWORD_NOT_NEAR_STRUCTURES;
import static org.smartregister.tasking.util.Constants.CONFIGURATION.DEFAULT_GEO_JSON_CIRCLE_SIDES;
import static org.smartregister.tasking.util.Constants.CONFIGURATION.DEFAULT_INDEX_CASE_CIRCLE_RADIUS_IN_METRES;
import static org.smartregister.tasking.util.Constants.CONFIGURATION.DISPLAY_DISTANCE_SCALE;
import static org.smartregister.tasking.util.Constants.CONFIGURATION.RESOLVE_LOCATION_TIMEOUT_IN_SECONDS;
import static org.smartregister.tasking.util.Constants.CONFIGURATION.VALIDATE_FAR_STRUCTURES;
...
import static org.smartregister.tasking.util.Utils.getAdminPasswordNotNearStructures;
import static org.smartregister.tasking.util.Utils.getInterventionLabel;
import static org.smartregister.tasking.util.Utils.getResolveLocationTimeoutInSeconds;
import static org.smartregister.tasking.util.Utils.isResidentialStructure;
...
@PrepareForTest({PreferencesUtil.class, MapboxMap.class, TestRevealApplication.class})
public class UtilsTest {
    ...
    public void setUp() throws Exception {
        ...
        taskingLibraryConfiguration = spy(new TestRevealApplication.TaskingLibraryConfiguration());
    ...
    public void testGetInterventionLabel() throws Exception {
        ...
        verify(taskingLibraryConfiguration).getInterventionLabel();
    }
    ...
    private TestRevealApplication initTestRevealApplicationMock() throws Exception {
        PowerMockito.mockStatic(TestRevealApplication.class);
        TestRevealApplication TestRevealApplication = mock(TestRevealApplication.class);
        PowerMockito.when(TestRevealApplication.class, "getInstance").thenReturn(TestRevealApplication);
        return TestRevealApplication;
    }

    /*@Test
    public void testValidateFarStructuresReturnsTrueWhenSettingsValueIsTrue() throws Exception {
        TestRevealApplication TestRevealApplication = initTestRevealApplicationMock();

        Map<String, Object> settings = new HashMap<>();
        settings.put(VALIDATE_FAR_STRUCTURES, "true");

        when(TestRevealApplication.getServerConfigs()).thenReturn(settings);
