...
import static org.smartregister.tasking.util.TaskingConstants.Tags.COUNTRY;
import static org.smartregister.tasking.util.TaskingConstants.Tags.DISTRICT;
import static org.smartregister.tasking.util.TaskingConstants.Tags.OPERATIONAL_AREA;
import static org.smartregister.tasking.util.TaskingConstants.Tags.PROVINCE;
import static org.smartregister.tasking.util.TaskingConstants.Tags.REGION;
import static org.smartregister.tasking.util.TaskingConstants.Tags.SUB_DISTRICT;
...
public class BaseDrawerPresenterTest extends BaseUnitTest {
    ...
    public void testOnViewResumedCallsCheckSyncedIfAlreadySyncedAndRefreshMapOnEventSaved() {
        ...
        Whitebox.setInternalState(taskingLibraryConfiguration, "refreshMapOnEventSaved", true);
        Whitebox.setInternalState(taskingLibraryConfiguration, "synced", true);
        Whitebox.setInternalState(presenter, "viewInitialized", true);
        when(preferencesUtil.getCurrentPlan()).thenReturn("IRS Lusaka");
    ...
    public void testOnViewResumedUpdateSyncStatusDisplayIfNotRefreshMapOnEventSavedAndSynced() {
        ...
        Whitebox.setInternalState(taskingLibraryConfiguration, "refreshMapOnEventSaved", false);
        Whitebox.setInternalState(taskingLibraryConfiguration, "synced", true);
        Whitebox.setInternalState(presenter, "viewInitialized", true);
        when(preferencesUtil.getCurrentPlan()).thenReturn("IRS Lusaka");
    ...
    public void testOnViewResumedUpdateSyncStatusDisplayIfNotRefreshMapOnEventSavedAndNotSynced() {
        ...
        Whitebox.setInternalState(taskingLibraryConfiguration, "refreshMapOnEventSaved", false);
        Whitebox.setInternalState(taskingLibraryConfiguration, "synced", false);
        Whitebox.setInternalState(presenter, "viewInitialized", true);
        when(preferencesUtil.getCurrentPlan()).thenReturn("IRS Lusaka");
