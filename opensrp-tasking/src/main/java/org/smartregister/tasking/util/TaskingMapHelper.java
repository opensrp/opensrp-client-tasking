...
public class TaskingMapHelper {
    ...
    public TaskingMapHelper() {
        mappingHelper = TaskingLibrary.getInstance().getTaskingLibraryConfiguration().getMappingHelper();
    }
    ...
    public void addIndexCaseLayers(MapboxMap mapboxMap, Context context, FeatureCollection featureCollection) {
        ...
        indexCaseLocation = mappingHelper.getCenter(indexCase.geometry().toJson());
