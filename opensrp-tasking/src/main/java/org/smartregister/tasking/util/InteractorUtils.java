...
import static org.smartregister.tasking.util.Constants.DatabaseKeys.CASE_CONFIRMATION_FIELD;
import static org.smartregister.tasking.util.Constants.DatabaseKeys.EVENT_TASK_TABLE;
import static org.smartregister.tasking.util.Constants.DatabaseKeys.EVENT_TYPE_FIELD;
import static org.smartregister.tasking.util.Constants.DatabaseKeys.FORM_SUBMISSION_ID;
import static org.smartregister.tasking.util.Constants.DatabaseKeys.SPRAYED_STRUCTURES;
import static org.smartregister.tasking.util.Constants.DatabaseKeys.TASK_ID;
...
public class InteractorUtils {
    ...
    public InteractorUtils(TaskRepository taskRepository, EventClientRepository eventClientRepository, ClientProcessorForJava clientProcessor) {
