        ...
        for (Event event : events) {
            ...
            try {
                ...
                while (cursor.moveToNext()) {
                    ...
                    event.addDetails(TaskingConstants.Properties.TASK_IDENTIFIER, task.getIdentifier());
                    event.addDetails(TaskingConstants.Properties.TASK_BUSINESS_STATUS, task.getBusinessStatus());
                    event.addDetails(TaskingConstants.Properties.TASK_STATUS, task.getStatus().name());
                    event.addDetails(TaskingConstants.Properties.LOCATION_ID, task.getForEntity());
                    event.addDetails(TaskingConstants.Properties.APP_VERSION_NAME, BuildConfig.VERSION_NAME);
